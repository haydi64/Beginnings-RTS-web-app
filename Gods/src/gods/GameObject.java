...
public abstract class GameObject {
	...
	public void takeDamage(int lostTroops) {
		System.out.println(color.toString() + " " + type.toString() + " lost: " + lostTroops);
...
//			deleteUnit();
	...
	public void print() {
		System.out.print(color.toString().substring(0, 1) + type.toString().substring(0, 4) + " ");
	}

	public void printHealth() {
		System.out.println(color.toString() + " " + type.toString() + ": " + this.healthyUnits + "/" + this.totalUnits);
	}
}

enum GameType {
	SWORD, SPEAR, VILLAGER, TOWN_HALL, BARRACKS
}
